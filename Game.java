...
public class Game {
   ...
   /**
    ...
    private void Initialize()
    {
        ...
        this.gameMaps.put("NWhallway", new TileMap("NWhallway.txt", this));
        this.gameMaps.put("NWhallroom1", new TileMap("NWhallroom1.txt", this));
        this.gameMaps.put("NWhallroom2", new TileMap("NWhallroom2.txt", this));
        this.gameMaps.put("NWhallroom3", new TileMap("NWhallroom3.txt", this));
        this.gameMaps.put("NWhallroom4", new TileMap("NWhallroom4.txt", this));
        this.gameMaps.put("foyer", new TileMap("foyer.txt", this));
        this.gameMaps.put("NEhallway", new TileMap("NEhallway.txt", this));
